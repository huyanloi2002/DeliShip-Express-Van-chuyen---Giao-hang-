...
import { getAllOrdersDelivered } from "../redux/actions/orderAction";
...
const OrdersDelivered = () => {
  ...
  useEffect(() => {
    dispatch(getAllOrdersDelivered({ token: auth.token }));
  }, [dispatch, auth]);
  ...
  return (
    <div className="oders_admin">
      <div className="orders_admin_content">
        <h2 className="title_orders">Đơn hàng đã giao thành công</h2>
